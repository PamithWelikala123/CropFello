...
<html>
    ...
    <div class="logo">
                    ...
                    <a href="<?=ROOT?>/sellerbidding"><img class="close" src="<?=ROOT?>/assets/images/postitem/close.png"> </a>
      </div>
      ...
      <div class="form1">
                ...
                <div class="right">
                                                                      ...
                                                                      <input class="bid-end-date" type="date" placeholder="  dd / mm / yyyy" name="exp">


                                                                      <label class="unit1">Initial Price</label>
                                                                      <label class="unit2">*</label>
                                                                      <input class="unit" name="unit" id="unit" type="text" placeholder="  Rs." >
                                                                      ...
                                                                      <input class ="discount" type="text"  name="discount" placeholder="  Rs." >
