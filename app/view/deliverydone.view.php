        ...
        <div class="content">
            <div class="leftbar">
                ...
                <div class="menu">
                  ...
                  <button onclick="document.location='deliverydone/index'"><img class="done"  src="<?=ROOT?>/assets/images/delivery/done.png"><span> Done</span></button><br>
            ...
            <div class="containerx">
                    ...
                    <h2 class="head">Pamith Welikala&nbsp wants to deliver&nbsp Papaya &nbsp 2 &nbspKgs &nbsp<br>from Godagama &nbsp to Thalawathugoda &nbsp</h2>
                      ...
                      <button class="Discard btn2">Delete &nbsp &#xf014 </button>
                    </div>
