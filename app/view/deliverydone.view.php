...
<body>
    <div class="container">
        ...
        <div class="item item3">
            ...
            <?php
                    $sql = "SELECT * FROM info WHERE status=2";
                    $result = $conn->query($sql);
            if ($result->num_rows > 0) { ?>
                    <?php while ($row = $result->fetch_assoc()) { ?>
                <div class="containerx">
                    <div class="item item-1">
                      <img class="profile-pic" src="<?=ROOT?>/assets/images/rushinpics/pics/man3.png">
                    ...
                    <div class="item item-2">
                      ...
                      <a href='todo.php?id=<?php echo $row['id'] ?>'<button class="Approve btn1">Done &nbsp  &#10004</button></a>
                      <a href='todo.php?eid=<?php echo $row['id'] ?>'<button class="Discard btn2">Discard &nbsp &#xf014 </button></a>
                    </div>
                  </div>                
                 <?php }?>
                 <?php }?>
