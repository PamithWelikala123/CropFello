...
<html>
    <head>
        ...
        <link rel="Stylesheet" href="<?=ROOT?>/assets/css/deliveryforgetpassword1.css">
    </head>
    <body>
  <div class="grid">
        ...
        <div>
                  ...
                  <img  class="img4" src="<?=ROOT?>/assets/images/editprofile/arrow-left-circle.svg" onclick="document.location='../Deliverylogin'">
