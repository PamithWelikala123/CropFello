            ...
            <div class="info">
                ...
                <div class="price">
                    <p style="float: right;"><span style="font-size: smaller; color: #FB7A7A; float: right;"><strong> <?=$data['discount']?><?=$data['discount1']?> OFF</strong></span><br>
                        <span style="font-size:larger; color: #0EBC1F;"><strong>1 KG</strong></span><span  style="font-size: 50%; color: #B3B3B3; ">/55KG &emsp;</span><span ><strong>RS <?=$data['price']?></strong><br></span>
