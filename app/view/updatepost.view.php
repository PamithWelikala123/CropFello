                         ...
                         <form class="" action="updatepost" method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="form-split2">
                                            ...
                                            <div class="form-group">
                                                            ...
                                                            <input class="basic-input-field disabled" placeholder="<?php echo $data['stock_size1'] ?>"  id="unit" type="text" onkeyup="GetDetail(this.value)" value="<?php echo $data['stock_size1'] ?>">
                                 ...
                                 <div class="form-split3">
                                      ...
                                      <div class="form-group">
                                                                  ...
                                                                  <input type="text" id="address" class="basic-input-field disabled" placeholder="address" name="Address">
